...
I didn't want to leave anyone at risk, so I didn't want to reupload the original **Random Rants** to [Render](https://render.com).

## Screenshots

![Home Screen](./screenshots/rr2.png)
![In-Chat Screen](./screenshots/rr3.png)
![Shared Soundboard Screen](./screenshots/rr4.png)
![Emoji Selection Screen](./screenshots/rr5.png)
![Customization Screen](./screenshots/rr6.png)
![Resource loading settings Screen](./screenshots/rr7.png)
